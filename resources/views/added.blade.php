    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div id="schoolsList" class="space-y-6">
            ...
            <div class="flex items-center p-6 bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div class="flex-1">
                    <h4 class="text-xl font-semibold text-gray-900 mb-2">1-maktab</h4>
                    <p class="text-gray-600">MFY: O‘zim toldirman</p>
                    <p class="text-gray-600">Qurilgan yili: 1995</p>
                </div>
            ...
            <div class="flex items-center p-6 bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div class="flex-1">
                    <h4 class="text-xl font-semibold text-gray-900 mb-2">45-maktab</h4>
                    <p class="text-gray-600">MFY: O‘zim toldirman</p>
                    <p class="text-gray-600">Qurilgan yili: 2000</p>
                </div>
                <div class="flex gap-3">
                    <button onclick="document.getElementById('editSchoolModal-2').classList.remove('hidden')" class="bg-yellow-500 text-white px-4 py-2 rounded-full hover:bg-yellow-600 transition-all duration-300">
                        <i class="fas fa-edit"></i> Tahrirlash
                    </button>
                    <form method="POST" action="delete_school.php" onsubmit="return confirm('Rostdan o‘chirmoqchimisiz?');">
            ...
            <div class="flex items-center p-6 bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300">
                ...
                <div class="flex gap-3">
                    <button onclick="document.getElementById('editSchoolModal-3').classList.remove('hidden')" class="bg-yellow-500 text-white px-4 py-2 rounded-full hover:bg-yellow-600 transition-all duration-300">
                        <i class="fas fa-edit"></i> Tahrirlash
                    </button>
                    <form method="POST" action="delete_school.php" onsubmit="return confirm('Rostdan o‘chirmoqchimisiz?');">
    ...
    <div class="bg-white rounded-3xl p-8 max-w-2xl w-full shadow-2xl animate-fade-in-up overflow-y-auto max-h-[80vh]">
        ...
        <form method="POST" action="edit_school.php">
            ...
            <div class="grid grid-cols-1 gap-4">
                ...
                <!-- Boshqa maydonlar xuddi shu tarzda -->
            </div>
            <div class="flex justify-end gap-4 mt-6">
