            ...
            @forelse($kindergartens as $kindergarten)
                <div class="flex flex-col sm:flex-row items-center p-6 bg-white rounded-3xl shadow-lg hover:shadow-xl transition-all duration-300 w-full">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3 mt-4 sm:mt-0">
                        <a href="{{ route('data', $kindergarten->id) }}" class="bg-blue-500 text-white px-4 py-2 rounded-full hover:bg-blue-600 transition-all duration-300 text-center">
        ...
        <form method="POST" action="{{ route('kindergarten.store') }}" enctype="multipart/form-data">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="text" id="yer_maydoni" name="yer_maydoni" class="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-600 focus:outline-none transition-all duration-300" placeholder="Masalan: 5000 m²" value="{{ old('yer_maydoni') }}">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="binolar_maydoni" name="binolar_maydoni" class="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-600 focus:outline-none transition-all duration-300" placeholder="Masalan: 3000 m²" value="{{ old('binolar_maydoni') }}">
                </div>
                <div>
                    <label for="istilidigan_maydon" class="block text-gray-700 font-semibold mb-2">Istilidigan maydon</label>
                    <input type="text" id="istilidigan_maydon" name="istilidigan_maydon" class="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-600 focus:outline-none transition-all duration-300" placeholder="Masalan: 2500 m²" value="{{ old('istilidigan_maydon') }}">
                </div>
                <div>
                    <label for="quvvati" class="block text-gray-700 font-semibold mb-2">Quvvati</label>
                    <input type="text" id="quvvati" name="quvvati" class="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-600 focus:outline-none transition-all duration-300" placeholder="Masalan: 500 o‘quvchi" value="{{ old('quvvati') }}">
                </div>
                <div>
                    <label for="oquvchi_soni" class="block text-gray-700 font-semibold mb-2">O‘quvchi soni</label>
                    <input type="number" id="oquvchi_soni" name="oquvchi_soni" min="0" class="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-600 focus:outline-none transition-all duration-300" placeholder="Masalan: 450" value="{{ old('oquvchi_soni') }}">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="oshxona_yoki_bufet_quvvati" name="oshxona_yoki_bufet_quvvati" class="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-600 focus:outline-none transition-all duration-300" placeholder="Masalan: 100 kishi" value="{{ old('oshxona_yoki_bufet_quvvati') }}">
                </div>
                <div>
                    <label for="sport_zal_soni_va_maydoni" class="block text-gray-700 font-semibold mb-2">Sport zal soni va maydoni</label>
                    <input type="text" id="sport_zal_soni_va_maydoni" name="sport_zal_soni_va_maydoni" class="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-600 focus:outline-none transition-all duration-300" placeholder="Masalan: 1, 200 m²" value="{{ old('sport_zal_soni_va_maydoni') }}">
                </div>
                <div>
                    <label for="faollar_zali_va_quvvati" class="block text-gray-700 font-semibold mb-2">Faollar zali va quvvati</label>
                    <input type="text" id="faollar_zali_va_quvvati" name="faollar_zali_va_quvvati" class="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-600 focus:outline-none transition-all duration-300" placeholder="Masalan: 1, 150 kishi" value="{{ old('faollar_zali_va_quvvati') }}">
                </div>
                <div>
                ...
                <div>
                    ...
                    <input type="text" id="gaz_istemoli" name="gaz_istemoli" class="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-600 focus:outline-none transition-all duration-300" placeholder="Masalan: 5000 m³" value="{{ old('gaz_istemoli') }}">
                </div>
                <div>
                    <label for="elektr_istemoli" class="block text-gray-700 font-semibold mb-2">1 yillik o‘rtacha elektr iste’moli</label>
                    <input type="text" id="elektr_istemoli" name="elektr_istemoli" class="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-600 focus:outline-none transition-all duration-300" placeholder="Masalan: 10000 kVt" value="{{ old('elektr_istemoli') }}">
                </div>
                <div>
                    <label for="issiqlik_istemoli" class="block text-gray-700 font-semibold mb-2">1 yillik o‘rtacha issiqlik iste’moli</label>
                    <input type="text" id="issiqlik_istemoli" name="issiqlik_istemoli" class="w-full px-4 py-3 rounded-lg border-2 border-blue-200 focus:border-blue-600 focus:outline-none transition-all duration-300" placeholder="Masalan: 2000 Gkal" value="{{ old('issiqlik_istemoli') }}">
                </div>
                <div>
