...
<head>
    ...
    <title>MTV - {{ $kindergarten->name }}</title>
    ...
    <div class="max-w-4xl mx-auto">
        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            <div>
                ...
                <p class="mt-2 text-gray-600">{{ $kindergarten->district->name }} tumani</p>
            </div>
            <div class="flex space-x-4">
                <a href="{{ route('kindergartens.index') }}" class="px-6 py-3 bg-gray-100 text-gray-700 rounded-lg font-medium border border-gray-300 hover:bg-gray-200 transition-colors duration-200 flex items-center">
                    <i class="fas fa-arrow-left mr-2"></i> Ro'yxatga qaytish
                </a>
                <a href="{{ route('kindergartens.edit', $kindergarten) }}" class="px-6 py-3 bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-lg font-medium hover:shadow-lg transition-all duration-200 flex items-center">
        ...
        <div class="bg-white rounded-2xl shadow-md overflow-hidden mb-8">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="text-lg font-medium text-gray-900">{{ $kindergarten->district->name }}</p>
                </div>
                <div class="md:col-span-2">
                    <p class="text-sm font-medium text-gray-500 mb-1">Manzil</p>
                    <p class="text-lg font-medium text-gray-900">{{ $kindergarten->address }}</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-md overflow-hidden mb-8">
            ...
            <div class="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <p class="text-lg font-medium text-gray-900">{{ $kindergarten->contact_number }}</p>
                </div>
                <div class="md:col-span-2">
                    <p class="text-sm font-medium text-gray-500 mb-1">Email</p>
                    <p class="text-lg font-medium text-gray-900">{{ $kindergarten->email }}</p>
                </div>
            </div>
        </div>
