...
<head>
    ...
    <meta name="description" content="Maktab ma'lumotlari va ta'lim muhiti haqida to'liq ma'lumot">
    <meta name="keywords" content="maktab, ta'lim, maktabgacha ta'lim, MTV">
    <title>{{ $added->name ?? 'MTV' }} - Maktab Ma'lumotlari</title>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20 items-center">
            ...
            <div class="hidden md:flex items-center gap-4">
                @auth
                    <a href="{{ route('logout') }}" id="logoutBtn" class="bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-6 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl hover:scale-105 transition-all duration-300">Chiqish</a>
                @else
    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white p-8 rounded-3xl shadow-lg">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mb-2">
                            ...
                            @if($added->lokatsiya)
                                <a href="{{ $added->lokatsiya }}" target="_blank" class="text-gray-600 hover:text-blue-600 hover:underline transition">Ko‘rish</a>
                            @else
                                Ma'lumot yo'q
                            @endif
                        </p>
                        <div class="mt-4">
                            ...
                            <div class="image-grid">
                                @if($added->maktab_rasmlari && is_array($added->maktab_rasmlari))
                                    @foreach($added->maktab_rasmlari as $rasm)
                                        <img loading="lazy" class="w-full h-32 object-cover rounded-lg transition-transform duration-300 hover:scale-105" src="{{ Storage::url($rasm) }}" alt="Maktab Rasmi">
                                    @endforeach
                                @else
                ...
                <div class="mt-8 flex justify-end">
                    <a href="{{ route('added', ['added' => $added->district_id]) }}" class="bg-gradient-to-r from-blue-500 to-indigo-600 text-white px-6 py-3 rounded-full font-semibold shadow-lg hover:shadow-xl transition-all duration-300">Orqaga</a>
                </div>
                <p class="text-gray-600 text-center">Ma'lumotlar topilmadi</p>
        </div>
    </div>
</section>
